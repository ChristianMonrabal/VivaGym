            ...
            <div class="scrollable-form-container">
                <form id="userForm" action="./pay.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" value="Christian">
                        <small class="error text-danger" style="display: none;">Este campo es obligatorio</small>
                    </div>
                    <div class="form-group">
                        <label for="apellidos">Apellidos:</label>
                        <input type="text" class="form-control" id="apellidos" name="apellidos" value="Monrabal Donis">
                        <small class="error text-danger" style="display: none;">Este campo es obligatorio</small>
                    </div>
                    <div class="form-group">
                        <label for="dni">DNI:</label>
                        <input type="text" class="form-control" id="dni" name="dni" value="49189559B">
                        <small class="error text-danger" style="display: none;">Este campo es obligatorio</small>
                    </div>
                    <div class="form-group">
                        <label for="email">Email:</label>
                        <input type="email" class="form-control" id="email" name="email" value="christian@gmail.com">
                        <small class="error text-danger" style="display: none;">Este campo es obligatorio</small>
                        <small class="error text-danger" id="email-error" style="display: none;">Correo electrónico inválido</small>
                    </div>
                    <div class="form-group">
                        <label for="contraseña">Contraseña:</label>
                        <input type="password" class="form-control" id="contraseña" name="contraseña" value="qweQWE123">
                        <small class="error text-danger" style="display: none;">Este campo es obligatorio</small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="numero_telefono" name="numero_telefono" value="620668678">
                        <small class="error text-danger" style="display: none;">Este campo es obligatorio</small>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" value="2004-04-26">
                        <small class="error text-danger" style="display: none;">Este campo es obligatorio</small>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="codigo_postal" name="codigo_postal" value="08905">
                        <small class="error text-danger" style="display: none;">Este campo es obligatorio</small>
                    </div>
                    <div class="form-group">
                        <label for="ciudad">Ciudad:</label>
                        <input type="text" class="form-control" id="ciudad" name="ciudad" value="barcelona">
                        <small class="error text-danger" style="display: none;">Este campo es obligatorio</small>
                    </div>
                    <div class="row">
