...
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        if (nombreCompleto.value.trim() === '') {
            showError(nombreCompleto, 'errorNombreCompleto', 'El campo es obligatorio');
            valid = false;
        }

        if (telefono.value.trim() === '') {
            showError(telefono, 'errorTelefono', 'El campo es obligatorio');
            valid = false;
        }

        if (email.value.trim() === '') {
            showError(email, 'errorEmail', 'El campo es obligatorio');
            valid = false;
        }

        if (cv.value.trim() === '') {
            showError(cv, 'errorCv', 'El campo es obligatorio');
            valid = false;
        }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Para ocultar el mensaje de error cuando el usuario empieza a escribir
